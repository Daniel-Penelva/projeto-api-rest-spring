...
public class WebConfigSecurity extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		 ...
		 * linha 42 - Mapeia a URL de logout e invalida o usuário
		 * linha 43 - Filtra requisições de login para autenticação
		 * linha 44 - Filtra demais requisições para verificar a presenção do TOKEN JWT no HEADER HTTP */
